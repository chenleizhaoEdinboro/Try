...
public class EdgeWeightedDigraph {
	...
	public EdgeWeightedDigraph(String fileName) throws IOException{
		...
		//int E = s.nextInt(); //16
		   while(s.hasNextInt()){
               ...
               DirectedEdge e = new DirectedEdge(vertex,w,weightDist, weightCost,placeName);
			   DirectedEdge eVerse = new DirectedEdge(w,vertex,weightDist, weightCost,placeName);
               addEdge(e);
			   addEdge(eVerse);
			   //addAnotherDirectEdge(e);
           }
   ...
   public void addAnotherDirectEdge(DirectedEdge e){
