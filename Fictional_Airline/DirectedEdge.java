...
public class DirectedEdge { 
     ...
     */
    public DirectedEdge(int v, int w, int weightDist,double weightCost,String[] namePlace) {
    ...
    public String toString() {
        ...
        return v + vName +"->" + w + wName +"  the distance is " + weightDist;
    }
	 ...
	 public String toStringCost() {
        ...
        return v + vName +"->" + w + wName +"  the cost is " + weightCost;
    }
    ...
    public static void main(String[] args) {
        ...
        DirectedEdge e = new DirectedEdge(12,34,200,5.67,name);
        StdOut.println(e);
    }
}
