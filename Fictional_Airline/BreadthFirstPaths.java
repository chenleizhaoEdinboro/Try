...
public class BreadthFirstPaths {
     ...
     */
    public BreadthFirstPaths(Graph G, String start, String end){
    ...
    public static void main(String[] args) throws IOException{
        ...
        BreadthFirstPaths bfs = new BreadthFirstPaths(G, startPlace, endPlace);
		
         int s = G.getPlaceNumber(startPlace);
         int t = G.getPlaceNumber(endPlace);
            if (bfs.hasPathTo(t)) {
                StdOut.printf("%s to %s (%d):  ", startPlace, endPlace, bfs.distTo(t));
                for (int x : bfs.pathTo(t)) {
                    if (x == s) {
						System.out.println(G.getPlaceName(x));
						//StdOut.print(x);
					}
                    else{
						System.out.println(G.getPlaceName(x));
